...
def capture_chart_png(vega_lite_spec: dict[str, Any], key: str, height: int = 600) -> bytes | None:
    """
...
"""
    ...
    import json
    html_with_spec = html.replace("SPEC_PLACEHOLDER", json.dumps(vega_lite_spec))
    
    # Render component and wait for base64 response
    base64_data = components.html(html_with_spec, height=height, scrolling=False, key=key)
